...
public class CommentController {
    ...
    public ResponseEntity<CommentRes> updateComment(@PathVariable Integer commentId, @RequestBody CommentReq commentReq) {
//        log.info("id: {}", commentId);
        CommentRes result = commentService.updateComment(commentId, commentReq.getContent());
